...
trait AnalysisResult{
  def toTuple(): (String, String, String, String)
}
...
case class SingleValue(name: String,
                       ...
                       description: String = "",
                       suggested: String = "",
                       severity: Severity = Severity.MODERATE) extends AnalysisResult {
  override def toTuple(): (String, String, String, String) = {
    (name, value, description, suggested)
  }
}
